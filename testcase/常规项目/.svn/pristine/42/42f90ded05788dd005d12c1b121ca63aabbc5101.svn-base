...
class C27222_Gamelist_Ready_Back(TestCase):
    '''
    玩家已准备游戏未开始，短时间切换后台
    '''
    owner = "LucyLiu"
...
class C27221_Gamelist_Ready_Lock(TestCase):
    '''
    玩家已准备游戏未开始，短时间锁屏
    '''
    owner = "LucyLiu"
...
class C27222_Gamelist_Ready_Back_Longtime(TestCase):
    '''
    玩家已准备游戏未开始，长时间切换后台
    '''
    owner = "LucyLiu"
...
class C2721_Gamelist_Ready_Lock_Longtime(TestCase):
    '''
    玩家进入房间未准备，长时间锁屏
    '''
    owner = "LucyLiu"
...
# __qtaf_seq_tests__ = [C27222_Gamelist_Ready_Back_Longtime]
