...
class C31261_DFQP_Match_Invitational1(TestCase):
    ...
    def run_test(self):
        ...
        self.match_page.screenshot("2.png")
        time.sleep(3)
        if(self.match_page.element_is_exist("立即升级")==True):
