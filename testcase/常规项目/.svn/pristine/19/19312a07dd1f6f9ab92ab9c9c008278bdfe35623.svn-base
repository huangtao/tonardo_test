...
class C31026_DFQP_Message_Calls(TestCase):
    ...
    def pre_test(self):
        ...
        global mid
        mid = self.common.get_config_value("casecfg", "mid")
        return1 = PHPInterface.send_message(int(mid), "接口发送话费碎片私信1","接口发送话费碎片私信1",400003,1,0)
        print return1
        # 初始化Luadriver
        self.luadriver = self.common.setupdriver()
        self.message_page = Message_Page()
...
class C31027_DFQP_Message_VIP(TestCase):
    ...
    def pre_test(self):
        ...
        global mid
        mid = self.common.get_config_value("casecfg", "mid")
        return1 = PHPInterface.send_message(int(mid), "接口发送vip私信","接口发送vip私信",4,1,0)
        # 初始化Luadriver
        self.luadriver = self.common.setupdriver()
        self.message_page = Message_Page()
        self.hall_page = Hall_Page()
...
class C31028_DFQP_Message_Interactivity(TestCase):
    ...
    def pre_test(self):
        ...
        return1 = PHPInterface.send_message(int(mid), "接口交互道具私信","接口交互道具私信",200,1,0)
        # 初始化Luadriver
        self.luadriver = self.common.setupdriver()
        self.message_page = Message_Page()
        self.hall_page = Hall_Page()
...
class C31029_DFQP_Message_Silver(TestCase):
    ...
    def pre_test(self):
        ...
        self.start_step("接口交互道具私信")
        print coin
        return1 = PHPInterface.send_message(int(mid), "交互道具私信","交互道具私信",0,2,0)
        self.message_page = Message_Page()
        self.hall_page = Hall_Page()
        self.personinfo_page = Personinfo_Page()
        self.backpack_page = Backpack_Page()
...
class C31030_DFQP_Message_Gold(TestCase):
    ...
    def pre_test(self):
        ...
        global crystal
        crystal= eval(mid).get('result', {'crystal': None}).get('crystal')  # 获取当前银币值
        print crystal
    ...
    def run_test(self):
        ...
        try:
            ...
            print ("没有消息")
        time.sleep(6)
        crystal1 = eval(mid).get('result', {'crystal': None}).get('crystal')  # 获取当前银币值
        print crystal1
...
class C31031_DFQP_Message_Object(TestCase):
    ...
    def pre_test(self):
        ...
        mid = self.common.get_config_value("casecfg", "mid")
        self.start_step("接口交互道具私信")
        return1 = PHPInterface.send_message(int(mid), "实物私信","实物私信",10045,1,0)
        # 初始化Luadriver
        self.luadriver = self.common.setupdriver()
        self.message_page = Message_Page()
        self.hall_page = Hall_Page()
...
class C31032_DFQP_Message_Three(TestCase):
    ...
    def pre_test(self):
        ...
        mid = self.common.get_config_value("casecfg", "mid")
        self.start_step("接口交互道具私信")
        return1 = PHPInterface.send_message(int(mid), "3种以上物品私信","3种以上物品私信",[10045,0,1],1,0)
        # 初始化Luadriver
        self.luadriver = self.common.setupdriver()
        self.message_page = Message_Page()
        self.hall_page = Hall_Page()
