...
class D25738_ThreeRoom_Sign_Display(TestCase):
    '''
    房间内身份标志显示
    '''
    owner = "LucyLiu"
...
class D25739_ThreeRoom_Cards_Display(TestCase):
    '''
    底牌及倍数
    '''
    owner = "LucyLiu"
...
class D25741_ThreeRoom_MultiplyDouble(TestCase):
    '''
    明牌加倍
    '''
    owner = "LucyLiu"
...
class D25744and25745_ThreeRoom_Trustee_Display(TestCase):
    '''
    托管/托管状态
    '''
    owner = "LucyLiu"
