...
class C082_DFQP_Match(TestCase):
    '''
    大厅比赛场界面显示
    '''
    owner = "MindyZhang"
    ...
    def run_test(self):
        ...
        self.match_page.wait_element("+金币").click()
        time.sleep(3)
        self.match_page.wait_element("箭头返回").click()
        time.sleep(3)
        self.start_step("点击+金条")
        self.match_page.wait_element("+金条").click()
        time.sleep(3)
        self.match_page.wait_element("箭头返回").click()
        time.sleep(3)
...
class C084_DFQP_Match_Bag(TestCase):
    '''
    大厅比赛场---物品箱
    '''
    owner = "MindyZhang"
...
class C085_DFQP_Match_Rank(TestCase):
    '''
    大厅比赛场---战绩
    '''
    owner = "MindyZhang"
...
class C086_DFQP_Match_Agenda(TestCase):
    '''
    大厅比赛场---今日赛程
    '''
    owner = "MindyZhang"
...
class C089_DFQP_Match_List(TestCase):
    '''
    大厅比赛场---列表刷新
    '''
    owner = "MindyZhang"
...
class C090_DFQP_Match_Invitational2(TestCase):
    ...
    def run_test(self):
        ...
        if(self.match_page.is_exist("notNow") == True):
            ...
            text1 = self.match_page.wait_element("notNow_text").get_attribute('text')
            ##print (text1)
            if(text1 == u"使用保险箱银币"):
    ...
    def post_test(self):
        ...
        '''
        self.common.closedriver()
__qtaf_seq_tests__ = [C082_DFQP_Match,C084_DFQP_Match_Bag]
