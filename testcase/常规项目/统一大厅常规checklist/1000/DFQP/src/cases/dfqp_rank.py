...
class C052_DFQP_Rank_Enterearn(TestCase):
    '''
    收益排行榜，查看界面显示
    '''
    owner = "MindyZhang"
    ...
    def run_test(self):
        ...
        self.rank_page.screenshot('C052_DFQP_Rank_Enter.png')
        time.sleep(1)
...
class C053_DFQP_Rank_Userinfo(TestCase):
    '''
    点击查看每个排行榜
    '''
    owner = "MindyZhang"
    ...
    def run_test(self):
        ...
        self.rank_page.wait_element("收益榜").click()
        self.rank_page.screenshot( 'C053_DFQP_Rank_Userinfo21.png')
        self.rank_page.wait_element("富豪榜").click()
        self.rank_page.screenshot('C053_DFQP_Rank_Userinfo21.png')
        time.sleep(2)
        self.rank_page.wait_element("返回").click()
...
class C054_DFQP_Rank_Userinfodetail(TestCase):
    '''
...
class C055_DFQP_Rank_Yesterday(TestCase):
    '''
    收益榜昨日/今日数据
    '''
    owner = "MindyZhang"
    ...
    def run_test(self):
        ...
        self.rank_page.screenshot('C055_DFQP_Rank_Yesterday1.png')
        time.sleep(2)
        self.rank_page.wait_element("今日").click()
        self.rank_page.screenshot('C055_DFQP_Rank_Yesterday2.png')
        time.sleep(2)
        self.rank_page.wait_element("返回").click()
        self.hall_page.wait_element("同步标志")
...
class C057_DFQP_Rank_RichUserinfo(TestCase):
    '''
    ...
    def run_test(self):
        ...
        time.sleep(2)
        self.rank_page.wait_element("确定举报").click()
        self.rank_page.screenshot('C057_DFQP_Rank_RichUserinfo.png')
        time.sleep(2)
        self.rank_page.wait_element("返回").click()
        self.hall_page.wait_element("同步标志")
...
class C059_DFQP_Rank_Entermall(TestCase):
    '''
    点击快速提升排名按钮
    '''
    owner = "MindyZhang"
...
# __qtaf_seq_tests__ = [C052_DFQP_Rank_Enterearn]
