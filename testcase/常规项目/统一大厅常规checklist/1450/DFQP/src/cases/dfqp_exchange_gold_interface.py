...
class C31064_DFQP_Exchange_gold1(TestCase):
    ...
    def pre_test(self):
        ...
        ##print AddMoney
        PHPInterface.add_money(self.casedata.get('mid'), AddMoney)  # 将银币值设为60000
...
class C31068_DFQP_Exchange_Gold_Exchange2(TestCase):
    ...
    def run_test(self):
        ...
        time.sleep(2)
        self.exchange_page.screenshot("Gold_Exchange1.png")
        dict1 = PHPInterface.get_user_info(self.casedata.get('mid'))  # 获取玩家信息
...
# __qtaf_seq_tests__ = [C31064_DFQP_Exchange_gold1]
