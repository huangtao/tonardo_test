...
class D0001_DoubleLaizi_PlayGame(TestCase):
    '''
    双癞子场玩牌
    '''
    owner = "LucyLiu"
    ...
    def gameplay(self):
        ...
        starttime = time.time()
        while self.game_page.element_is_exist("破产对话框",3)==False:
    ...
    def run_test(self):
        self.hall_page.screenshot("进双癞子场游戏.png")
        self.start_step("进入双癞子场")
        while self.hall_page.element_is_exist("游戏列表"):
            elments = self.hall_page.get_elements("游戏列表")
            elments[1].click()
